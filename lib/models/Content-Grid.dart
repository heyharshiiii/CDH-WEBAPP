...
Content(textt: Text("ARTICLE",style:contentTitle,textAlign: TextAlign.center,), img: Image.asset("assets/images/contents/article.gif",fit: BoxFit.cover,),),
...
Content(textt: Text("TECH BYTES",style: contentTitle,textAlign: TextAlign.center,), img: Image.asset("assets/images/contents/tech1.jfif",fit: BoxFit.cover,)),
